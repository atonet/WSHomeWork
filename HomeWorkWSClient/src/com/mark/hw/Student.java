...
public class Student {
    ...
    @XmlElementRef(name = "address", namespace = "http://homeworkwsserver", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "tel", namespace = "http://homeworkwsserver", type = JAXBElement.class, required = false)
