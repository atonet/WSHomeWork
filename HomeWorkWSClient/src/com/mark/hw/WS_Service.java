 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://homeworkwsserver", wsdlLocation = "http://localhost:9080/HomeWorkWSServer/services/WS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://homeworkwsserver", "WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9080/HomeWorkWSServer/services/WS?wsdl");
     ...
     *     returns WS
     */
    @WebEndpoint(name = "WSHttpPort")
    public WS getWSHttpPort() {
        return super.getPort(new QName("http://homeworkwsserver", "WSHttpPort"), WS.class);
    }
     ...
     */
    @WebEndpoint(name = "WSHttpPort")
    public WS getWSHttpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://homeworkwsserver", "WSHttpPort"), WS.class, features);
    }
